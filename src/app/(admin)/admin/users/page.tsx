...
import { purgeStaleUnverifiedClients } from "@/modules/auth/register.service";
...
export default async function AdminUsersPage() {
  ...
  await purgeStaleUnverifiedClients();
  ...
  return (
    <div className="space-y-8">
      <PageHeader
        ...
        title="Utilisateurs"
        description="Uniquement les comptes confirmés : les investisseurs n'apparaissent qu'après validation du code OTP reçu par e-mail. Les banques et administrateurs sont créés par le Ministère."
      />
